...
import { FileText, X, Loader2, Presentation } from 'lucide-react';
      ...
      <CardContent className="p-0">
        ...
        {!files.length && (
          <Dropzone
            ...
            hint="untuk diubah ke PowerPoint"
          />
        )}

        {files.length > 0 && (
          <div className="mt-6 px-4">
            <h3 className="font-semibold text-blue-900 mb-3">File yang akan dikonversi ke PowerPoint:</h3>
          ...
          >
            {isProcessing ? (
              ...
              <>
                ...
                Konversi ke PowerPoint Sekarang
              </>
            )}
          </Button>
        </div>
