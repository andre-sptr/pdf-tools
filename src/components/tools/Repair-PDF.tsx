...
import { FileText, X, Loader2, Wrench } from 'lucide-react';
...
export default function RepairPdfTool() {
  const {
    ...
    endpoint: '/repair-pdf',
    outputFilename: 'Hasil-Perbaiki-PDFTools.pdf',
    maxFiles: 1,
    minFiles: 1,
  });

  const processingText = `Memperbaiki... ${uploadProgress}%`;
      ...
      <CardContent className="p-0">
        ...
        {!files.length && (
          <Dropzone
            ...
            multiple={false}
            maxFiles={1}
            dropzoneText="Seret & Lepaskan PDF yang ingin diperbaiki di sini"
          />
        )}

        {files.length > 0 && (
          <div className="mt-6 px-4">
            <h3 className="font-semibold text-blue-900 mb-3">File yang akan diperbaiki:</h3>
