  ...
  const handleCompressPdf = async () => {
    if (!file) {
      toast({
        ...
        description: "Silakan pilih 1 file PDF untuk dikompres.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      const response = await axios.post('https://api-pdf.andresptr.site/api/compress-pdf', formData, {
        responseType: 'blob',
      });
      ...
      link.href = url;
      link.setAttribute('download', 'Hasil-Kompres-PDFTools.pdf');
      ...
      toast({
        title: "Berhasil!",
        description: "File PDF Anda telah berhasil dikompres dan diunduh.",
      });
      ...
      toast({
        ...
        description: "Tidak dapat memproses file Anda. Pastikan server backend berjalan.",
        variant: "destructive",
      });
    } finally {
      ...
      <CardContent className="p-0">
        ...
        {file && (
          <div className="mt-6 px-4">
            <h3 className="font-semibold text-blue-900 mb-3">File yang akan dikompres:</h3>
